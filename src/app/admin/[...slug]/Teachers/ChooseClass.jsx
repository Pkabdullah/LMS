                ...
                {classes.map((item) => (
                  <tr key={item._id} className="hover:bg-gray-50 transition duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      <Link href={`/admin/Teachers/ChooseSubject/${item._id}`}>
  ...
  // const ShowClasses = () => {
  //   const classes = useSelector((state) => state.user.stdClass);
  //   console.log("classes here in teachers",classes)
  //   return (
  //     <>
  //     <div className="relative">
  //       <div className="sticky top-0 bg-white z-10 shadow-md p-4">
  //         <h2 className="text-2xl font-semibold text-gray-800">Choose Class</h2>
  //       </div>

  //       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
  //         {classes.map((item) => (
  //           <div key={item.classId} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
  //             <div className="flex flex-col gap-4">
  //               <h3 className="text-xl font-semibold text-gray-800">{item.className}</h3>
  //               <button
